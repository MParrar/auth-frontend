...
export function PaginationPrevious({ onClick, disabled = false, className, children = 'Previous' }) {
  return (
    <span className={clsx(className, 'grow basis-0')}>
      <Button onClick={onClick}
        disabled={disabled}
        plain  aria-label="Previous page">
...
export function PaginationNext({ onClick, disabled = false, className, children = 'Next' }) {
  return (
...
export function PaginationPage({ onClick, className, current = false, children }) {
  return (
    <Button
    onClick={onClick}
      plain
